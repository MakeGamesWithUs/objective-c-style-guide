...
Thanks to the [raywenderlich.com](https://github.com/raywenderlich/objective-c-style-guide) team for creating the baseline for this guide!
...
```objc
static NSString * const RWTAboutViewControllerName = @"John Doe";
